...
$lang = [
	...
	'view_log_invalid' => '瀏覽量記錄文件({logfile})無法寫入，請設定其屬性 777 或刪除後重新建立',
	...
	'search_toomany' => '抱歉，站點設定每分鐘系統最多響應搜索請求 {maxspm} 次，請稍候再試',
	...
	'postperm_qqonly_nopermission' => '為避免您的賬號被盜用，請您綁定QQ賬號後發帖，綁定後請使用QQ賬號登入<br /><a href="connect.php?mod=config"><img src="'.STATICURL.'image/common/qq_bind_small.gif" /></a>',
	...
	'message_can_not_send_9' => '收件人為空或對方屏蔽了您的短訊',
	...
	'plugin_module_nonexistence' => '指定的插件模組文件({mod})不存在或存在語法錯誤，請檢查是否已將插件完整上傳',
	...
	'photos_do_not_support_the_default_settings' => '抱歉，預設相冊不支持本設定',
	'no_privilege_album_edit' => '抱歉，您沒有權限編輯此相冊',
	'album_name_errors' => '抱歉，您尚未正確設定相冊名',
	...
	'album_can_not_share' => '抱歉，指定的相冊因隱私設定不能夠被分享',
	...
	'topicadmin_live_noset_error' => '該主題並沒有設定為直播帖',
	...
	'account_sign_error' => '簽名檔驗證錯誤，請重試',
