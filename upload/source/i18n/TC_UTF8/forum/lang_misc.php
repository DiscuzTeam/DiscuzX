...
$lang =
	...
	'modcp_logs_action_login' => '登入',

	'uch_selectalbum' => '請選擇相簿',
	'uch_noalbum' => '抱歉，您還沒有相簿，',
	'click_here' => '點擊這裡',
	'uch_createalbum' => '創建自己的相簿吧！',

	'pm_from' => '發件人',
	'pm_to' => '收件人',
	'pm_date' => '日期',

	'share_message' => '您好！我在 {$_G[\'setting\'][\'bbname\']} 看到了這篇帖子，認爲很有價值，特推薦給您。\\n\\n$thread[\'subject\']\\n地址 [url={$threadurl}]{$threadurl}[/url]\\n\\n希望您能喜歡',
	...
	'perms_allowsetattachperm' => '允許設定附件權限',
	...
	'perms_allowmodpost' => '審覈帖子',
	'perms_allowmoduser' => '審覈用戶',
	...
	'connectguest_message_search' => ['尚未登入', '先登入'],
	...
	'connectguest_message_mobile_search' => ['尚未登入', '先登入'],
