...
$lang =
	...
	'get_passwd_new_pwd' => '在上面的鏈接所打開的頁面中輸入新的密碼後提交，您即可使用新的密碼登入網站了。您可以在用戶控製麪板中隨時修改您的密碼。',
	...
	'email_reset_new_email' => '新的 Email 地址爲：{$var[\'email\']} ，驗證郵件發送時間爲：{$var[\'request_datetime\']}',
	...
	'email_register_click_link' => '您只需點擊下面的鏈接即可進行用戶註冊，以下鏈接有效期爲3天。過期可以重新請求發送一封新的郵件驗證：',
...
或錯誤的填寫了生日資訊。本郵件不會多次重複發送，',
	...
	'moderate_member_reason' => '這個郵箱地址在 {$var[\'bbname\']} 被新用戶註冊時所使用，且管理員設定了對新用戶需要進行人工審覈，本郵件將通知您提交申請的審覈結果。',
