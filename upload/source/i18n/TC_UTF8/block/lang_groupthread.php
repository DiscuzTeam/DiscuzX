...
$lang =
	...
	'groupthread_keyword_comment' => '設定標題包含的關鍵字。注意: 留空為不進行任何過濾； 關鍵字中可使用通配符 *； 匹配多個關鍵字全部，可用空格或 AND 連接。如 win32 AND unix； 匹配多個關鍵字其中部分，可用 | 或 OR 連接。如 win32 OR unix',
	'groupthread_startrow' => '起始數據行數',
	'groupthread_startrow_comment' => '如需設定起始的數據行數，請輸入具體數值，0 為從第一行開始，以此類推',
	'groupthread_items' => '顯示數據條數',
	'groupthread_items_comment' => '設定一次顯示的主題條目數，請設定為大於 0 的整數',
	'groupthread_titlelength' => '標題最大字節數',
	'groupthread_maxlength_comment' => '設定當標題長度超過本設定時，是否將標題自動縮減到本設定中的字節數，0 為不自動縮減',
	...
	'groupthread_picpre_comment' => '設定是否在主題前加入圖片形式的圖標，輸入圖片的 URL (絕對或相對)地址即可，留空為不顯示前綴圖標',
	'groupthread_tids' => '指定主題',
	'groupthread_tids_comment' => '設定要指定顯示的主題 tid ，多個 tid 請用半角逗號“,”隔開。注意: 留空為不進行任何過濾',
	'groupthread_keyword' => '標題關鍵字',
	'groupthread_keyword_comment' => '設定標題包含的關鍵字。注意: 留空為不進行任何過濾； 關鍵字中可使用通配符 *； 匹配多個關鍵字全部，可用空格或 AND 連接。如 win32 AND unix； 匹配多個關鍵字其中部分，可用 | 或 OR 連接。如 win32 OR unix',
	...
	'groupthread_sortids_comment' => '設定特定分類資訊的主題。注意: 全選或全不選均為不進行任何過濾',
