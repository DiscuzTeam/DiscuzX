...
$lang =
	...
	'groupthread_keyword_comment' => '設定標題包含的關鍵字。注意: 留空爲不進行任何過濾； 關鍵字中可使用通配符 *； 匹配多個關鍵字全部，可用空格或 AND 連接。如 win32 AND unix； 匹配多個關鍵字其中部分，可用 | 或 OR 連接。如 win32 OR unix',
	'groupthread_startrow' => '起始數據行數',
	'groupthread_startrow_comment' => '如需設定起始的數據行數，請輸入具體數值，0 爲從第一行開始，以此類推',
	'groupthread_items' => '顯示數據條數',
	'groupthread_items_comment' => '設定一次顯示的主題條目數，請設定爲大於 0 的整數',
	'groupthread_titlelength' => '標題最大字節數',
	'groupthread_maxlength_comment' => '設定當標題長度超過本設定時，是否將標題自動縮減到本設定中的字節數，0 爲不自動縮減',
	'groupthread_fnamelength' => '標題最大字節數包含版塊名稱',
	'groupthread_fnamelength_comment' => '設定標題長度是否將所在版塊名稱的長度一同計算在內',
	'groupthread_summarylength' => '主題簡短內容文字數',
	'groupthread_summarylength_comment' => '設定主題簡短內容的文字數，0 爲使用預設值 255',
	'groupthread_picpre' => '前綴圖標',
	'groupthread_picpre_comment' => '設定是否在主題前加入圖片形式的圖標，輸入圖片的 URL (絕對或相對)地址即可，留空爲不顯示前綴圖標',
	'groupthread_tids' => '指定主題',
	'groupthread_tids_comment' => '設定要指定顯示的主題 tid ，多個 tid 請用半角逗號“,”隔開。注意: 留空爲不進行任何過濾',
	'groupthread_keyword' => '標題關鍵字',
	'groupthread_keyword_comment' => '設定標題包含的關鍵字。注意: 留空爲不進行任何過濾； 關鍵字中可使用通配符 *； 匹配多個關鍵字全部，可用空格或 AND 連接。如 win32 AND unix； 匹配多個關鍵字其中部分，可用 | 或 OR 連接。如 win32 OR unix',
	'groupthread_typeids' => '主題分類',
	'groupthread_typeids_comment' => '設定特定分類的主題。注意: 全選或全不選均爲不進行任何過濾',
	'groupthread_typeids_all' => '全部的主題分類',
	'groupthread_sortids' => '分類資訊',
	'groupthread_sortids_comment' => '設定特定分類資訊的主題。注意: 全選或全不選均爲不進行任何過濾',
	...
	'groupthread_groupthreadort_comment' => '設定是否在主題列表中，給分類資訊的主題前加上分類資訊名稱',
	'groupthread_highlight' => '顯示主題的高亮特性',
	'groupthread_highlight_comment' => '設定是否顯示主題的高亮特性',
	'groupthread_digest' => '精華主題過濾',
	'groupthread_digest_comment' => '設定特定的主題範圍。注意: 全選或全不選均爲不進行任何過濾',
	...
	'groupthread_stick_comment' => '設定特定的主題範圍。注意: 全選或全不選均爲不進行任何過濾',
	...
	'groupthread_special_comment' => '設定特定的主題範圍。注意: 全選或全不選均爲不進行任何過濾',
	...
	'groupthread_orderby_comment' => '設定以哪一字段或方式對主題進行排序',
