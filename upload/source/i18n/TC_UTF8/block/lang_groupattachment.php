...
$lang =
	...
	'groupattachment_gtids_comment' => '設定圈子所在分類，可以按住 CTRL 多選，全選或全不選均為不做限制',
	...
	'groupattachment_items_comment' => '設定一次顯示的圖片主題條目數，請設定為大於 0 的整數',
	'groupattachment_titlelength' => '標題長度',
	'groupattachment_titlelength_comment' => '設定當附件名稱/帖子標題顯示的最大長度',
	'groupattachment_summarylength' => '內容長度',
	'groupattachment_summarylength_comment' => '設定附件介紹/帖子內容顯示的最大長度',
	'groupattachment_maxwidth' => '圖片最大寬度(像素)',
	'groupattachment_maxwidth_comment' => '設定是否自動縮小或放大圖片的尺寸到本設定的寬度，0 為不自動縮放',
	'groupattachment_maxheight' => '圖片最大高度(像素)',
	'groupattachment_maxheight_comment' => '設定是否自動縮小或放大圖片的尺寸到本設定的高度，0 為不自動縮放',
