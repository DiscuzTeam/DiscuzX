...
$lang = [
	...
	'pm_report_content' => '<a href="home.php?mod=space&uid={reporterid}" target="_blank">{reportername}</a>舉報短訊：<br>來自<a href="home.php?mod=space&uid={uid}" target="_blank">{username}</a>的短訊<br>內容：{message}',
	...
	'message_can_not_send_onlyfriend' => '該用戶只接收好友發送的短訊',


	'friend_subject' => '<a href="{url}" target="_blank">{username} 請求加您爲好友</a>',
	...
	'lack_of_access_to_upload_file_size' => '無法獲取上傳檔案大小',
	'only_allows_upload_file_types' => '只允許上傳jpg、jpeg、gif、png標準格式的圖片',
	'unable_to_create_upload_directory_server' => '伺服器無法創建上傳目錄',
	...
	'apply_mtag_manager' => '想申請成爲 <a href="\\1" target="_blank">\\2</a> 的圈主，理由如下:\\3。<a href="\\1" target="_blank">(點擊這裡進入管理)</a>',
	...
	'do_stat_login' => '登入用戶',
	'do_stat_mobilelogin' => '手機登入用戶',
	'do_stat_connectlogin' => 'QQ登入用戶',
